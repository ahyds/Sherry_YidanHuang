# <span style="font-family:Times New Roman;"> Unit 1 Homework: Kickstart My Chart</span>

## Background

<span style="font-family:Papyrus">Over $2 billion has been raised using the massively successful crowdfunding service, Kickstarter, but not every project has found success. Of the more than 300,000 projects launched on Kickstarter, only a third have made it through the funding process with a positive outcome.</span>
